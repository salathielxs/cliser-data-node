...
echo "======================================================================"
echo "15.2.8-C.15-A — RECOVERY CONSOLIDATION REGRESSION GATE"
echo "======================================================================"
...
print(
    ...
    + str(required_states.issubset(actual_states))
)

print(
    "RECOVERABLE_STATES="
    + ",".join(sorted(recoverable_values))
)

print(
    "TERMINAL_STATES="
    + ",".join(sorted(terminal_values))
)

print(
    "TRANSACTION_CLASS="
    + str(Transaction is not None)
)

print(
    "ROLLBACK_METHOD="
    + str(hasattr(Transaction, "rollback"))
)

print(
    "VALID_TRANSITIONS="
    + str(bool(VALID_TRANSITIONS))
)

if (
    required_states.issubset(actual_states)
    and hasattr(Transaction, "rollback")
    and bool(VALID_TRANSITIONS)
    and bool(RECOVERABLE_STATES)
...
echo
echo "[4] COMMIT MARKER — DIRECT TEST EXECUTION"
echo "----------------------------------------------------------------------"
...
echo
echo "[6] CRASH RECOVERY — DIRECT TEST EXECUTION"
echo "----------------------------------------------------------------------"
...
echo
echo "[7] RECOVERY IDEMPOTENCY — PYTEST"
echo "----------------------------------------------------------------------"
